...
public final class BubbleRelativeLayout extends RelativeLayout {
    ...
    public BubbleRelativeLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            typed = context.obtainStyledAttributes(attrs, R.styleable.BubbleRelativeLayout);
            radiusSize = typed.getDimension(R.styleable.BubbleRelativeLayout_brl_radius_size, radiusSize);
            shadowRadiusSize = typed.getDimension(R.styleable.BubbleRelativeLayout_brl_shadow_radius_size, shadowRadiusSize);

            strokeSize = typed.getDimension(R.styleable.BubbleRelativeLayout_brl_stroke_size, strokeSize);
            arrowWidth = typed.getDimension(R.styleable.BubbleRelativeLayout_brl_arrow_width, arrowWidth);
            arrowHeight = typed.getDimension(R.styleable.BubbleRelativeLayout_brl_arrow_height, arrowHeight);
            arrowMargin = typed.getDimension(R.styleable.BubbleRelativeLayout_brl_arrow_margin_top, arrowMargin);

            strokeColorNormal = typed.getColor(R.styleable.BubbleRelativeLayout_brl_stroke_color_normal, strokeColorNormal);
            strokeColorSelect = typed.getColor(R.styleable.BubbleRelativeLayout_brl_stroke_color_press, strokeColorSelect);

            isArrowRight = typed.getBoolean(R.styleable.BubbleRelativeLayout_brl_arrow_right, isArrowRight);
            isArrowLeft = typed.getBoolean(R.styleable.BubbleRelativeLayout_brl_arrow_left, isArrowLeft);
